...
wordsFromText.splice(wordsFromText.indexOf("Interview"), "Intership"); //Adding Internship exactly before Interview
console.log(wordsFromText);
// wordsFromText.splice(wordsFromText.indexOf("Interview"))
